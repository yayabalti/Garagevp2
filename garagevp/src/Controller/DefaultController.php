...
class DefaultController extends AbstractController
{
    ...
    public function petitesAnnonces(Request $request, ServiceventevoitureoccasionRepository $voitureRepository): Response
    {
        try {
            ...
            $annonces = array_filter($annonces, function(ServiceVenteVoitureOccasion $annonce) use ($minPrice, $maxPrice, $minKm, $maxKm, $minYear, $maxYear) {
