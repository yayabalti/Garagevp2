...
use App\Repository\ServiceMecaniqueRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=ServiceMecaniqueRepository::class)
 */
class ServiceMecanique
{
    /**
     * @ORM\Id
     * @ORM\Column(type="string", length=250)
     */
    private string $idMecanique; // ID unique du service mécanique
    ...
    public function getIdMecanique(): string
    {
        return $this->idMecanique;
    }

    public function setIdMecanique(string $idMecanique): self
    {
        $this->idMecanique = $idMecanique;
        return $this;
    }
